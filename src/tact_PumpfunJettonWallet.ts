...
function dictValueParserFactoryDeploy(): DictionaryValue<FactoryDeploy> {
 ...
 type PumpfunJettonWallet_init_args = {
    $$type: 'PumpfunJettonWallet_init_args';
    owner: Address;
    master: Address;
}

function initPumpfunJettonWallet_init_args(src: PumpfunJettonWallet_init_args) {
    return (builder: Builder) => {
        let b_0 = builder;
        b_0.storeAddress(src.owner);
        b_0.storeAddress(src.master);
...
async function PumpfunJettonWallet_init(owner: Address, master: Address) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
    let builder = beginCell();
    builder.storeRef(__system);
    builder.storeUint(0, 1);
    initPumpfunJettonWallet_init_args({ $$type: 'PumpfunJettonWallet_init_args', owner, master })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const PumpfunJettonWallet_errors: { [key: number]: { message: string } } = {
...
const PumpfunJettonWallet_types: ABIType[] = [
...
const PumpfunJettonWallet_getters: ABIGetter[] = [
    {"name":"get_wallet_data","arguments":[],"returnType":{"kind":"simple","type":"JettonWalletData","optional":false}},
]

const PumpfunJettonWallet_receivers: ABIReceiver[] = [
...
export class PumpfunJettonWallet implements Contract {
    
    static async init(owner: Address, master: Address) {
        return await PumpfunJettonWallet_init(owner, master);
    }
    
    static async fromInit(owner: Address, master: Address) {
        const init = await PumpfunJettonWallet_init(owner, master);
        const address = contractAddress(0, init);
        return new PumpfunJettonWallet(address, init);
    }
    
    static fromAddress(address: Address) {
        return new PumpfunJettonWallet(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  PumpfunJettonWallet_types,
        getters: PumpfunJettonWallet_getters,
        receivers: PumpfunJettonWallet_receivers,
        errors: PumpfunJettonWallet_errors,
    };
