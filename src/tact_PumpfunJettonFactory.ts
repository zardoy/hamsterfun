...
function dictValueParserFactoryDeploy(): DictionaryValue<FactoryDeploy> {
 ...
 type PumpfunJettonFactory_init_args = {
    $$type: 'PumpfunJettonFactory_init_args';
    owner: Address;
}

function initPumpfunJettonFactory_init_args(src: PumpfunJettonFactory_init_args) {
    return (builder: Builder) => {
        let b_0 = builder;
        b_0.storeAddress(src.owner);
    };
...
async function PumpfunJettonFactory_init(owner: Address) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
    let builder = beginCell();
    builder.storeRef(__system);
    builder.storeUint(0, 1);
    initPumpfunJettonFactory_init_args({ $$type: 'PumpfunJettonFactory_init_args', owner })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const PumpfunJettonFactory_errors: { [key: number]: { message: string } } = {
...
const PumpfunJettonFactory_types: ABIType[] = [
...
const PumpfunJettonFactory_getters: ABIGetter[] = [
    {"name":"owner","arguments":[],"returnType":{"kind":"simple","type":"address","optional":false}},
]

const PumpfunJettonFactory_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"typed","type":"CreateToken"}},
    {"receiver":"internal","message":{"kind":"typed","type":"ChangeOwner"}},
    {"receiver":"internal","message":{"kind":"typed","type":"Deploy"}},
]

export class PumpfunJettonFactory implements Contract {
    
    static async init(owner: Address) {
        return await PumpfunJettonFactory_init(owner);
    }
    
    static async fromInit(owner: Address) {
        const init = await PumpfunJettonFactory_init(owner);
        const address = contractAddress(0, init);
        return new PumpfunJettonFactory(address, init);
    }
    
    static fromAddress(address: Address) {
        return new PumpfunJettonFactory(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  PumpfunJettonFactory_types,
        getters: PumpfunJettonFactory_getters,
        receivers: PumpfunJettonFactory_receivers,
        errors: PumpfunJettonFactory_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: CreateToken | ChangeOwner | Deploy) {
