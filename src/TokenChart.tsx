...
const createChart = (elem: HTMLDivElement, abortSignal: AbortSignal) => {
...
export default function TradingHistoryChart() {
    ...
    useEffect(() => {
        ...
        createChart(elem.current!, abortController.signal)
        return () => {
            abortController.abort()
        }
    }, [])

    return <div ref={elem} style={{ width: '100%', height: '100%' }} />
}
